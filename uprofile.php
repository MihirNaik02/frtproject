...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="uprofile.php" class="active">
          <i class='bx bx-box'></i>
  ...
  <section class="home-section">
        ...
        <div class="profile">
            <form action="uprofile.php" method="post" class="form-container">
            
                <label for="user"><b>User Name</b></label>
                <input type="text" placeholder="Enter Your Name" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['uname']?>" name="user" required>
  
                <label for="email"><b>Email</b></label>
                <input type="text" placeholder="Enter Your Email" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['uemail']?>" name="email" required>
  
                <label for="designation"><b>Designation</b></label>
                <input type="text" placeholder="Enter Your Designation" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['udesignation']?>" name="designation" required>
  
                <label for="mobile"><b>Mobile Number</b></label>
                <input type="text" placeholder="Enter Your Mobile Number" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['umobile']?>" name="mobile" required></br>

                <button type="submit" class="btn" name="update" onclick="submit()" value="Edit">Update Profile</button>
            </form>
        </div>
        <style>
