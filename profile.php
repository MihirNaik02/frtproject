    ...
    <section class="home-section">
        ...
        <div class="profile">
            <form action="profile.php" method="post" class="form-container">
                ...
                <input type="text" placeholder="Enter Your Hospital Name" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['hname']?>" name="fname" required>
  
                <label for="email"><b>Email</b></label>
                <input type="text" placeholder="Enter Your Hospital Email" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['hemail']?>" name="email" required>
  
                <label for="designation"><b>Designation</b></label>
                <input type="text" placeholder="Enter Your Designation" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['husertype']?>" name="designation" required>
  
                <label for="mobile"><b>Mobile Number</b></label>
                <input type="text" placeholder="Enter Your Mobile Number" value="<?php
                    session_start();
                    error_reporting(0);
                    echo $_SESSION['hmobile']?>" name="mobile" required></br>

                <button type="submit" class="btn" onclick="submit()" name="update" value="Edit">Update Profile</button>
            </form>
        </div>
        <style>
