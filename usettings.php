<?php
  include("uchangepass.php");
  include("udeleteaccount.php");
  require("alert.php");
?>
<!DOCTYPE html>
...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="usettings.php" class="active">
          <i class='bx bx-cog'></i>
  ...
  <section class="home-section">
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-24 mx-auto">
            <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center mt-20">User Settings</h1>
            <div class="flex flex-wrap m-10">
              ...
              <div class="form-popup" id="myForm">
                  <form action="usettings.php" method="post" class="form-container">
              ...
              <div class="form-popup1" id="myForm1">
                  <form action="usettings.php" method="post" class="form-container1">
