    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
               ...
               <?php
                ...
                ?>
                            <tr>
                                ...
                                <td class="data"><?php echo $data['patient'] ?></td>
                                <td class="data"><?php echo $data['disease'] ?></td>
        ...
        <div class="top-sales box">
          <div class="title">Overview in Short</div></br>
          <ol class="top-sales-details">
          <?php
                    $i=0;
                    $disp="select *from `$_SESSION[hname]`;";
                    $smt=mysqli_query($conn,$disp);
                    $resultcheck=mysqli_num_rows($smt);
                    ?>
                    <l>Total Number of Users: <b><?php echo $resultcheck; ?> Users</b></l></br></br>
                    <?php
                    if($resultcheck > 0){
                        while($row=mysqli_fetch_assoc($smt)){
                            $user=$row['user'];
                            $dissp="select *from `$user`;";
                              ...
                              if($check > 0){
                                  while($data=mysqli_fetch_assoc($smmt)){
                                    $i++;
                                    ?>
                                    <l>Total Number of Patients of <?php echo $user; ?>: <b><?php echo $check; ?> Patients</b></l></br></br>
                ...
                ?>
                <l>Total Number of Patients: <b><?php echo $i; ?> Patients</b></l>
