...
<body>
    ...
    <section class="home-section">
        ...
        <button onclick="openForm()" id="adduser" class="inline-flex text-white bg-purple-500 border-0 py-1 px-4 focus:outline-none hover:bg-purple-600 rounded">Add Patients</button></br></br>
        <div class="form-popup" id="myForm">
            <form action="patients.php" method="post" class="form-container">
              <h1 class="header"><b>Add Patients</b></h1>
          
              <label for="patient"><b>Patient Name</b></label>
              <input type="text" placeholder="Enter Patients Name" name="patient" required>

              <label for="disease"><b>Disease</b></label>
              <input type="text" placeholder="Enter Patients Disease" name="disease" required>

              <label for="email"><b>Patients Email-ID</b></label>
              <input type="text" placeholder="Enter Patients Email Address" name="email">

              <label for="mobile"><b>Patients Mobile Number</b></label>
              <input type="text" placeholder="Enter Patients Mobile Number" name="mobile" required>

              <label for="date"><b>Date</b></label></br>
              <input class="mb-3 w-full pt-2 pb-2 bg-gray-200 border-gray-200 bx-border-radius-100%" type="date" placeholder="Enter Date" name="date" required></br>


          
              <button type="submit" class="btn" value="Add User" onclick="Submit()">Add Patient</button>
        ...
        <table class="user">
            ...
            <tr>
                ...
                <th class="data"><b>Doctor Assigned</b></th>
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td class="data"><?php echo $row['ID']; echo $row['doctor'] ?></td>
                                
                                <td class="data"><?php echo "<a href='udelete.php?rn=$row[ID]'><i class='bx bx-trash'></i></a>" ?></td>
                            </tr>
                <?php
                        }
                    }
